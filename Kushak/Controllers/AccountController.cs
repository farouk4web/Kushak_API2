    ...
    public class AccountController : ApiController
    {
        ...
        public UserInfoViewModel GetUserInfo()
        {
            ...
            return new UserInfoViewModel
            {
                ...
                AccountPicSrc = currentUser.ProfileImageSrc,
        ...
        public IHttpActionResult ChangeProfilePicture()
        {
            ...
            if (picture != null || picture.ContentLength > 0)
            {
                ...
                if (isSupported == true)
                {
                    ...
                    var path = Path.Combine(HttpContext.Current.Server.MapPath("~/Uploads/Users/"), currentUserId + ".png");
                    picture.SaveAs(path);

                    var currentUser = _context.Users.Find(currentUserId);
                    currentUser.ProfileImageSrc = "/Uploads/Users/" + currentUserId + ".png";
        ...
        #region External Logins if you want to use it just UNCOMMENT 
